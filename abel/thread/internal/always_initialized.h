...
#ifndef ABEL_THREAD_INTERNAL_ALWAYS_INITIALIZED_H_
#define ABEL_THREAD_INTERNAL_ALWAYS_INITIALIZED_H_


#include <utility>

#include "abel/functional/function.h"
#include "abel/thread/internal/object_array.h"
...
namespace abel {
    namespace thread_internal {
        ...
        private:
            ...
            abel::function<void(void *)> initializer_;
        };
...
#endif  // ABEL_THREAD_INTERNAL_ALWAYS_INITIALIZED_H_
